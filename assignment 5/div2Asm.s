/*******************************************************************************
File name       : div2Asm.s
Description     : Assembly language function for dividing number by 2
*******************************************************************************/   
...
Description     : Calls C code to print a string; 
                  computes half of its input argument
C Prototype     : int div2Asm(val)
                : Where val is the value to calculate it's value divided by 2
